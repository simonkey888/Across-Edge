...
from .schema import CURRENT_SCHEMA_VERSION,UPSTREAM_EVENT_VERSION
...
class ShadowCoordinator:
    ...
    def parse_line(self,line:str)->dict|None:
        ...
        if obj.get('version')!=UPSTREAM_EVENT_VERSION:raise UpstreamEventError('unsupported upstream instrumentation version')
        return obj
