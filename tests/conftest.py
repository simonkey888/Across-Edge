...
def make_deposit(*,origin=42161,dest=8453,deposit_id=7,exclusive='0x'+'0'*64,deadline=0,block=10,ts=100,tx='0xdep',recipient=None,output_amount=990):
    return DepositEvent(origin,dest,deposit_id,'0x'+'1'*64,recipient or '0x'+'2'*64,'0x'+'3'*64,'0x'+'4'*64,1000,output_amount,exclusive,deadline,999999,block,tx,ts,block_hash='0xblock',log_index=1)
