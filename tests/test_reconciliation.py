...
def shadow(store,key='42161:7',trace='t'):
 r=ShadowRecord(3,'r',key,42161,7,8453,'i','o',1,1,'',0,'open',trace_id=trace,ta_monotonic_ns=100,t0_monotonic_ns=90,t1_monotonic_ns=110,t2_monotonic_ns=120,t3_monotonic_ns=130,live_equivalent_confirmations_satisfied=True,transaction_ready=True);store.upsert_shadow(r);return r
